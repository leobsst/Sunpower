...
document.addEventListener( 'DOMContentLoaded', function() {
    ...
    splide.on( 'pagination:updated', function () {
        ...
        if (index === 0) {
          ...
          subtitle1.innerHTML = "Rejoingnez nous!";
          subtitle2.innerHTML = "Notre projet";
          text1.innerHTML = "Nous intervenons aussi bien auprès des collectivités que des particuliers. Un projet ? Contactez-nous via nos formulaires de contact personnalisés!";
